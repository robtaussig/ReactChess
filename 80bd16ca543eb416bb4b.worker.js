...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  findBestMove: function findBestMove(board, specMoves, depth) {
	    var moves = _ai_new2.default.parseMoveClusters(_ai_new2.default.findAllPieces(board, specMoves.currentSide).map(function (piece) {
	      return _ai_new2.default.findAllLegalMovesByPiece(piece, board, specMoves);
	    }));
	    if (moves.length === 0) return { checkmate: true, side: specMoves.currentSide };
	    var bestMove = null;
...
/***/ }
/******/ ]);
//# sourceMappingURL=80bd16ca543eb416bb4b.worker.js.map