...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  //RNBQKBNRPPPPPPPP----------------
	  //----------------pppppppprnbqkbnr
	  convertBoard: function convertBoard(board) {
	    var boardString = "";
	  ...
	  color: function color(piece, _color) {
	    if (_color === 'w') {
	  ...
	  canMove: function canMove(board, from, to) {},
	
	  findAllLegalMovesByPiece: function findAllLegalMovesByPiece(board, position) {
	    var allMoves = [];
	    debugger;
	    for (var i = 0; i < 63; i++) {
	      if (canMove(board, position, i)) {}
	    }
	  }
...
/***/ }
/******/ ]);
//# sourceMappingURL=35e47c0cc01791d77322.worker.js.map