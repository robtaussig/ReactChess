...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  findAllPieces: function findAllPieces(board, color) {
	    ...
	    var converted = new _ai_new2.default(board);
	  ...
	  _createClass(Ai, [{
	    ...
	    value: function pawnMoves(position) {
	      ...
	      for (var i = 0; i < legalDirs.length; i++) {
	        var _currentPos = position + legalDirs[i];
	        if (this.checkObstruction(_currentPos)) {
	          allMoves.push(_currentPos);
	        }
	      }
	      var captureDirs = [11 * (color === 'w' ? -1 : 1), 9 * (color === 'w' ? -1 : 1)];
	      for (var _i = 0; _i < captureDirs; _i++) {
	        if (this.inBounds(position + captureDirs[_i]) && this.canTake(color, currentPos)) {
	    ...
	    value: function rookMoves(position) {
	      ...
	      var color = this.color(position, board);
	      for (var i = 0; i < legalDirs.length; i++) {
	        var _currentPos2 = position + legalDirs[i];
	        while (this.checkObstruction(_currentPos2)) {
	          allMoves.push(_currentPos2);
	          _currentPos2 += legalDirs[i];
	        }
	        if (this.inBounds(_currentPos2) && this.canTake(color, _currentPos2)) {
	          allMoves.push(_currentPos2);
	        }
	      }
	      return allMoves;
	    ...
	    value: function knightMoves(position) {
	      ...
	      var color = this.color(position, board);
	      for (var i = 0; i < legalDirs.length; i++) {
	        var _currentPos3 = position + legalDirs[i];
	        if (this.checkObstruction(_currentPos3) || this.canTake(color, _currentPos3)) {
	          allMoves.push(_currentPos3);
	        }
	      }
	      return allMoves;
	    }
	    ...
	    value: function bishopMoves(position) {
	      ...
	      var color = this.color(position, board);
	      for (var i = 0; i < legalDirs.length; i++) {
	        var _currentPos4 = position + legalDirs[i];
	        while (this.checkObstruction(_currentPos4)) {
	          allMoves.push(_currentPos4);
	          _currentPos4 += legalDirs[i];
	        }
	        if (this.inBounds(_currentPos4) && this.canTake(color, _currentPos4)) {
	          allMoves.push(_currentPos4);
	        }
	      }
	      return allMoves;
	    ...
	    value: function kingMoves(position) {
	      ...
	      var color = this.color(position, board);
	      for (var i = 0; i < legalDirs.length; i++) {
	        var _currentPos5 = position + legalDirs[i];
	        if (this.checkObstruction(_currentPos5) || this.canTake(color, _currentPos5)) {
	          allMoves.push(_currentPos5);
	        }
	      }
	      return allMoves;
	    }
	    ...
	    value: function queenMoves(position) {
	      ...
	      var color = this.color(position, board);
	      for (var i = 0; i < legalDirs.length; i++) {
	        var _currentPos6 = position + legalDirs[i];
	        while (this.checkObstruction(_currentPos6)) {
	          allMoves.push(_currentPos6);
	          _currentPos6 += legalDirs[i];
	        }
	        if (this.inBounds(_currentPos6) && this.canTake(color, _currentPos6)) {
	          allMoves.push(_currentPos6);
	        }
	      }
	      return allMoves;
...
/***/ }
/******/ ]);
//# sourceMappingURL=4ff6248df26d2e38b841.worker.js.map