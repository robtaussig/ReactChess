	...
	var Ai = function () {
	  ...
	  _createClass(Ai, [{
	    ...
	    value: function hasAttackers(position) {
	      ...
	      for (var _i2 = 0; _i2 < knightChecks.length; _i2++) {
	        ...
	        while (this.checkObstruction(_currentPos2)) {
	          _currentPos2 += knightChecks[_i2];
	        }
	        var _piece2 = board[_currentPos2].toLowerCase();
	        if (this.inBounds(_currentPos2) && (_piece2 === 'r' || _piece2 === 'q') && this.color(_currentPos2, board) !== color) {
	          return true;
	        }
	      }
	    }
	    ...
	    value: function pawnMoves(position) {
	      ...
	      for (var _i3 = 0; _i3 < captureDirs; _i3++) {
	        var capturePos = position + captureDirs[_i3];
...
/***/ }
/******/ ]);
//# sourceMappingURL=623d1198d5fa7d473dbf.worker.js.map