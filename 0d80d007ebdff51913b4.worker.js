	  ...
	  _createClass(Ai, [{
	    ...
	    value: function hasAttackers(position) {
	      ...
	      for (var _i3 = 0; _i3 < pawnChecks.length; _i3++) {
	        ...
	        if (this.inBounds(_currentPos3) && _piece3 === 'n' && this.color(_currentPos3, board) !== color) {
	          return true;
	        }
	      }
	    }
	    ...
	    value: function pawnMoves(position) {
	      ...
	      for (var _i4 = 0; _i4 < captureDirs; _i4++) {
	        var capturePos = position + captureDirs[_i4];
...
/***/ }
/******/ ]);
//# sourceMappingURL=0d80d007ebdff51913b4.worker.js.map