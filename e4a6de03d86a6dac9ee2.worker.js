	...
	module.exports = {
	  findBestMove: function findBestMove(board, specMoves, depth) {
	    ...
	    for (var i = 0; i < moves.length; i++) {
	      var currentNode = new _board_eval2.default(ai, moves[i], specMoves, depth);
...
/***/ function(module, exports) {
	...
	var BoardEval = function BoardEval(ai, move, specialMoves, depth) {
	  ...
	  this.score = this.evaluateMove(ai.board, move);
	};
...
/***/ }
/******/ ]);
//# sourceMappingURL=e4a6de03d86a6dac9ee2.worker.js.map