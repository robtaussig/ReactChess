	...
	var Ai = function () {
	  ...
	  _createClass(Ai, [{
	    ...
	    value: function hasAttackers(position) {
	      ...
	      var nonKnightChecks = [-1, -11, -10, -9, 1, 11, 10, 9];
	      for (var i = 0; i < nonKnightChecks.length; i++) {
	        var currentPos = position + nonKnightChecks[i];
	        while (this.checkObstruction(currentPos)) {
	          currentPos += nonKnightChecks[i];
	        }
...
/***/ }
/******/ ]);
//# sourceMappingURL=4463a5f2d37b19ff693e.worker.js.map