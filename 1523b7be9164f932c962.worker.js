...
/***/ function(module, exports, __webpack_require__) {
	...
	var _board_eval = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./board_eval.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	module.exports = {
	  findBestMove: function findBestMove(board, specMoves, depth) {
	    ...
	    for (var i = 0; i < moves.length; i++) {
	      var currentNode = new _board_eval2.default(ai.board, moves[i], specMoves, depth);
...
/***/ }
/******/ ]);
//# sourceMappingURL=1523b7be9164f932c962.worker.js.map