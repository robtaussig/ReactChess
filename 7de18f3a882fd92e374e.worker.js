...
/***/ function(module, exports, __webpack_require__) {
	...
	var newAI = __webpack_require__(3);
	...
	module.exports = {
	  ...
	  findAllPieces: function findAllPieces(board, color) {
	    ...
	    var converted = newAI.convertBoard(board);
	    var returnPieces = [];
...
/***/ function(module, exports) {
	...
	var Ai = function () {
	  ...
	  _createClass(Ai, [{
	    ...
	    key: 'color',
	    value: function color(piece, _color) {
	      if (_color === 'w') {
	    ...
	    key: 'findAllPieces',
	    value: function findAllPieces(board, color) {
	      var positions = [];
	      for (var i = 0, n = board.length; i < n; i++) {
	        var piece = board[i];
	    ...
	    key: 'allLegalMoves',
	    value: function allLegalMoves(board, positions) {
	      var moves = [];
	    ...
	    value: function findAllLegalMovesByPiece(board, position) {
	      var allMoves = void 0;
	      switch (board[position]) {
	        case 'P':
	          allMoves = this.pawnMoves(board, position, 'black');
	          break;
	        case 'p':
	          allMoves = this.pawnMoves(board, position, 'white');
	          break;
	        case 'R':
	          allMoves = this.rookMoves(board, position, 'black');
	          break;
	        case 'r':
	          allMoves = this.rookMoves(board, position, 'white');
	          break;
	        case 'N':
	          allMoves = this.knightMoves(board, position, 'black');
	          break;
	        case 'n':
	          allMoves = this.knightMoves(board, position, 'white');
	          break;
	        case 'B':
	          allMoves = this.bishopMoves(board, position, 'black');
	          break;
	        case 'b':
	          allMoves = this.bishopMoves(board, position, 'white');
	          break;
	        case 'K':
	          allMoves = this.kingMoves(board, position, 'black');
	          break;
	        case 'k':
	          allMoves = this.kingMoves(board, position, 'white');
	          break;
	        case 'Q':
	          allMoves = this.queenMoves(board, position, 'black');
	          break;
	        case 'q':
	          allMoves = this.queenMoves(board, position, 'white');
	          break;
	        default:
	          allMoves = [];
	      }
	    ...
	    key: 'pawnMoves',
	    value: function pawnMoves(board, position, color) {}
	  }]);
...
/***/ }
/******/ ]);
//# sourceMappingURL=7de18f3a882fd92e374e.worker.js.map