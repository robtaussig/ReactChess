	  ...
	  _createClass(Ai, [{
	    ...
	    value: function findAllLegalMovesByPiece(board, position) {
	      ...
	      switch (board[position].toLowerCase()) {
	        case 'p':
	          allMoves = this.pawnMoves(board, position);
	          break;
	        case 'r':
	          allMoves = this.rookMoves(board, position);
	          break;
	        case 'n':
	          allMoves = this.knightMoves(board, position);
	          break;
	        case 'b':
	          allMoves = this.bishopMoves(board, position);
	          break;
	        case 'k':
	          allMoves = this.kingMoves(board, position);
	          break;
	        case 'q':
	          allMoves = this.queenMoves(board, position);
	          break;
	        default:
	          allMoves = [];
	      }
	    ...
	    key: 'pawnMoves',
	    value: function pawnMoves(board, position) {}
	  }, {
	    key: 'rookMoves',
	    value: function rookMoves(board, position) {
	      var blindMoves = [];
	      var legalDirs = [-1, 1, -10, 10];
	      for (var i = 0; i < 4; i++) {
	        var currentPos = position;
	        while (this.legalMove(currentPos, currentPos + legalDirs[i])) {
	          currentPos += legalDirs[i];
	          blindMoves.push(currentPos);
	        }
	      }
	    }
	  }, {
	    key: 'knightMoves',
	    value: function knightMoves(board, position) {}
	  }, {
	    key: 'bishopMoves',
	    value: function bishopMoves(board, position) {}
	  }, {
	    key: 'kingMoves',
	    value: function kingMoves(board, position) {}
	  }, {
	    key: 'QueenMoves',
	    value: function QueenMoves(board, position) {}
	  }]);
...
/***/ }
/******/ ]);
//# sourceMappingURL=ce02e432e55676eb7a72.worker.js.map