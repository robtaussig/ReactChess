...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  findBestMove: function findBestMove(board, specMoves, depth) {
	    ...
	    var moves = this.parseMoveClusters(this.findAllPieces(board, specMoves.currentSide).map(function (piece) {
	      return _this.findAllLegalMovesByPiece(piece, board, specMoves);
	    }));
	  ...
	  findAllPieces: function findAllPieces(board, color) {
	    ...
	    board.forEach(function (row, i) {
	      row.forEach(function (square, j) {
	        var testSquare = _this2.parseSquare(board, i, j);
	  ...
	  findAllLegalMovesByPiece: function findAllLegalMovesByPiece(piece, board, specMoves) {
	    ...
	    if (piece.type === 'r') {
	      allMoves = allSquares.filter(function (square) {
	        ...
	        return Ai.Ai.canMove(square[0], square[1], board, piece.pos, specMoves);
	      }).map(function (move) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=4f03f677eecd62248ae7.worker.js.map