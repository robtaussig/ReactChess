...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  convert: function convert(move) {
	    var from = [move[0] % 10 - 1, Math.floor(move[0] / 10) - 1];
	    var to = [move[1] % 10 - 1, Math.floor(move[1] / 10) - 1];
	    return [from, to];
	  }
...
/***/ function(module, exports) {
	...
	var BoardEval = function () {
	  function BoardEval(ai, move, depth) {
	    ...
	    this.color = this.ai(move[0], ai.board);
...
/***/ }
/******/ ]);
//# sourceMappingURL=74d76ebf646e210c63ea.worker.js.map