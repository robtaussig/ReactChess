	  ...
	  _createClass(Ai, [{
	    ...
	    value: function hasAttackers(position) {
	      ...
	      for (var _i2 = 0; _i2 < knightChecks.length; _i2++) {
	        ...
	        var _piece2 = board[_currentPos2].toLowerCase();
	      ...
	      for (var _i3 = 0; _i3 < pawnChecks.length; _i3++) {
	        ...
	        var _piece3 = board[_currentPos3].toLowerCase();
	        if (this.inBounds(_currentPos3) && _piece3 === 'p' && this.color(_currentPos3, board) !== color) {
	          return true;
	        }
	      }
	
	      var kingChecks = [11 * (color === 'w' ? -1 : 1), 9 * (color === 'w' ? -1 : 1)];
	      for (var _i4 = 0; _i4 < kingChecks.length; _i4++) {
	        var _currentPos4 = position + kingChecks[_i4];
	        var _piece4 = board[_currentPos4].toLowerCase();
	        if (this.inBounds(_currentPos4) && _piece4 === 'p' && this.color(_currentPos4, board) !== color) {
	          return true;
	        }
	      }
	    }
	    ...
	    value: function pawnMoves(position) {
	      ...
	      for (var _i5 = 0; _i5 < captureDirs; _i5++) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=9b4d9da79500fac36a7a.worker.js.map