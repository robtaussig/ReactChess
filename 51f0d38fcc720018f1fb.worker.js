...
/***/ function(module, exports) {
	...
	var BoardEval = function () {
	  ...
	  _createClass(BoardEval, [{
	    ...
	    key: 'numMoves',
	    value: function numMoves(pos, board) {}
	  }, {
	    key: 'pawnPosition',
	    value: function pawnPosition(pos, board) {
	      return this.central(pos) * MATERIAL[board[pos]];
	    }
	  }, {
	    key: 'rookPosition',
	    value: function rookPosition(pos, board) {
	    ...
	    key: 'knightPosition',
	    value: function knightPosition(pos, board) {
	      return this.central(pos) * MATERIAL[board[pos]];
	    }
	  }, {
	    key: 'bishopPosition',
	    value: function bishopPosition(pos, board) {
	      return this.ai.bishopMoves(pos, board).length * MATERIAL[board[pos]] * 0.01;
	    }
	  }, {
	    key: 'queenPosition',
	    value: function queenPosition(pos, board) {}
	  }, {
	    key: 'kingPosition',
	    value: function kingPosition(pos, board) {}
	  }, {
	    key: 'piecePosition',
	    value: function piecePosition(pos, board) {
	      switch (board[pos].toLowerCase()) {
	        case 'p':
	          return this.pawnPosition(pos);
	        case 'n':
	          return this.knightPosition(pos);
	        case 'r':
...
/***/ }
/******/ ]);
//# sourceMappingURL=51f0d38fcc720018f1fb.worker.js.map