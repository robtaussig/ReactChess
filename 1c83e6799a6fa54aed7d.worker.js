...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  checkCastle: function checkCastle(pos, toX, toY, pieces) {
	    ...
	    var color = pieces[pos[1]][pos[0]][0][0];
	    if (toX === 2 && toY === pos[1] && this.checkObstruction(toX - 1, toY, pos, pieces) && notInCheck(toX + 1, toY, pos, pieces) && findAttackers(king, pieces, color === 'w' ? 'b' : 'w', false).length === 0) {
	      return specialMoves[color].castleQueenSideStatus;
	    } else if (toX === 6 && toY === pos[1] && this.checkObstruction(toX, toY, pos, pieces) && notInCheck(toX - 1, toY, pos, pieces) && findAttackers(king, pieces, color === 'w' ? 'b' : 'w', false).length === 0) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=1c83e6799a6fa54aed7d.worker.js.map