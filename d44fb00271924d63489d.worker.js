...
/***/ function(module, exports) {
	...
	var Ai = function () {
	  ...
	  _createClass(Ai, [{
	    ...
	    key: 'rookMoves',
	    value: function rookMoves(board, position, color) {}
	  }, {
	    key: 'knightMoves',
	    value: function knightMoves(board, position, color) {}
	  }, {
	    key: 'bishopMoves',
	    value: function bishopMoves(board, position, color) {}
	  }, {
	    key: 'kingMoves',
	    value: function kingMoves(board, position, color) {}
	  }, {
	    key: 'QueenMoves',
	    value: function QueenMoves(board, position, color) {}
	  }]);
...
/***/ }
/******/ ]);
//# sourceMappingURL=d44fb00271924d63489d.worker.js.map