	  ...
	  _createClass(Ai, [{
	    ...
	    value: function emptyBetween(board, from, to) {
	      ...
	      if (Math.floor(from / 10) === Math.floor(to / 10)) {
	        ...
	        for (var _i6 = from; _i6 <= to; _i6 += 10) {}
	      }
	    ...
	    value: function checkCastle(board, position) {
	      ...
	      if (this.specialMoves.queenSideCastle) {
	        if (this.emptyBetween(board, position, 12) && color === 'b') {
	          moves.push([position, 13]);
	        } else if (this.emptyBetween(board, position, 82)) {
	          moves.push([position, 83]);
	        }
	      }
	
	      if (this.specialMoves.kingSideCastle) {
	        if (this.emptyBetween(board, position, 17) && color === 'b') {
	          moves.push([position, 17]);
	        } else if (this.emptyBetween(board, position, 87)) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=a50e564aa8b5cbec090b.worker.js.map