...
/***/ function(module, exports) {
	...
	var piecePosition = function piecePosition() {};
	...
	var BoardEval = function () {
	  ...
	  _createClass(BoardEval, [{
	    ...
	    value: function evaluateMove(board, move, depth) {
	      var score = this.evaluateBoard(board, 'b');
	    }
	  }, {
	    key: 'evaluateBoard',
	    value: function evaluateBoard(board, color) {
	      ...
	      for (var i = 0, n = board.length; i < n; i++) {
	        ...
	        positionalScore += this.evaluatePosition(i, board);
	      }
	      return materialScore;
	    }
	  }, {
	    key: 'evaluatePosition',
	    value: function evaluatePosition(pos, board) {
...
/***/ }
/******/ ]);
//# sourceMappingURL=f843d5fbcb41bdc5511a.worker.js.map