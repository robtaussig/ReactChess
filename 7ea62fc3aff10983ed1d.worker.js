	...
	var Ai = function () {
	  ...
	  _createClass(Ai, [{
	    ...
	    value: function inCheck(move) {
	      ...
	      var kingPos = this.findPiece('k', color);
	    ...
	    value: function hasAttackers(position) {
	      ...
	      for (var i = 0; i < bishopsQueensCheck.length; i++) {
	        ...
	        var piece = board[currentPos].toLowerCase();
	        if (this.inBounds(currentPos) && (piece === 'b' || piece === 'q') && this.color(currentPos, board) !== color) {
	          return true;
	        }
	      }
	
	      var rooksQueensCheck = [-11, -9, 11, 9];
	      for (var _i = 0; _i < bishopsQueensCheck.length; _i++) {
	        var _currentPos = position + bishopsQueensCheck[_i];
	        while (this.checkObstruction(_currentPos)) {
	          _currentPos += bishopsQueensCheck[_i];
	        }
	        var _piece = board[_currentPos].toLowerCase();
	        if (this.inBounds(_currentPos) && (_piece === 'b' || _piece === 'q') && this.color(_currentPos, board) !== color) {
	          return true;
	        }
	      }
	    ...
	    value: function pawnMoves(position) {
	      ...
	      for (var _i2 = 0; _i2 < captureDirs; _i2++) {
	        var capturePos = position + captureDirs[_i2];
...
/***/ }
/******/ ]);
//# sourceMappingURL=7ea62fc3aff10983ed1d.worker.js.map