...
/***/ function(module, exports) {
	...
	var knightPosition = function knightPosition(pos, board) {
	  var score = 0;
	  var moves = [-12, -21, -19, -8, 12, 21, 19, 8];
	  for (var i = 0; i < moves.length; i++) {
	    var newPos = pos + moves[i];
	    if (inBounds(newPos)) {
	      score += central(newPos);
	    }
	  }
	};
	...
	var piecePosition = function piecePosition(pos, board) {
	  switch (board[pos].toLowerCase()) {
	    case 'p':
	      return pawnPosition(pos, board);
	    case 'n':
	      return knightPosition(pos, board);
	    default:
	      return 0;
	  }
	};
...
/***/ }
/******/ ]);
//# sourceMappingURL=2e84db9c9000f54a9f19.worker.js.map